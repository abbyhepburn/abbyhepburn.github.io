...
test('terminal and email copy controls work', async () => {
  ...
  expect(document.querySelector('.hero-photo-column .hero-portrait img')).toHaveAttribute('src', '/abby.jpeg');
  expect(document.querySelector('.hero-content .hero-identity')).toBeInTheDocument();
